...
# Purpose
This repository is the **Citadel Universe** static website (1995 Amiga game "Citadel" and its universe), deployed as a GitHub Pages site (pawelmat.github.io). The goal of these instructions is to help AI coding agents be immediately productive editing, testing and deploying small, focused changes.
...
- Primary local preview: VS Code + Live Preview plugin. Open an HTML file in the editor, click "Show Preview" and connect external browser at http://127.0.0.1:3000/ (use 127.0.0.1, not localhost, to avoid 401 errors on fonts/icons).
...
- Images: add new images to `assets/img/` (use subfolders such as `gallery/`, `maps/` or the img root as appropriate) and reference them with relative paths in HTML.
...
- The Bootstrap framework is used to build the site. When asked to add new elements, check the Bootstrap documentation for existing elements and styles: https://getbootstrap.com/docs/5.3/getting-started/introduction/ The most important sections are Layout, Components, Content and Customize.
...
# Where to look first
- For full project context and structure, see root [AGENTS.md](../AGENTS.md).
- [README.md](README.md) — project description and copyright.
...
- https://getbootstrap.com/docs/5.3/getting-started/introduction/ and https://getbootstrap.com/docs/5.3/examples/ for Bootstrap documentation and examples.
